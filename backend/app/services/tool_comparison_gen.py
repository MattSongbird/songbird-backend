...
class ToolState(BaseModel):
    ...
    voice_style: Optional[str] = "neutral-informative"
    tool: str = "tool_comparison_gen"
...
def build_prompt(state: ToolState) -> ToolState:
    try:
        state.prompt = (
            f"Compare two or more tools or platforms using a {state.voice_style} tone.
"
            f"Highlight strengths, weaknesses, use cases, and include a summary table if appropriate.
