...
class ToolState(BaseModel):
    ...
    voice_style: Optional[str] = "persuasive-professional"
    tool: str = "email_generator"
...
def build_prompt(state: ToolState) -> ToolState:
    try:
        state.prompt = (
            f"You are a professional email copywriter. Generate a persuasive email with a {state.voice_style} tone based on the following instructions:
